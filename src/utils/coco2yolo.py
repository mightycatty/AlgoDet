...
class COCO2YOLO:
    def __init__(self, json_file, output, category_txt: str='class_id.txt'):
...
def main(json_file: str = r'/home/justsomeone/data/public/fashionpedia/labels/instances_attributes_val2020.json',
         output: str = r'val'):
    COCO2YOLO(json_file, output, category_txt='train.txt').coco2yolo()
